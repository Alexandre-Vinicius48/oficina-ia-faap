    ...
    <>
      ...
      <main id="conteudo" className="flex-1">
        <div className="mx-auto max-w-3xl px-5 py-12">
          ...
          <Link
            href="/inscricao"
            className="mt-10 inline-flex w-full items-center justify-center rounded-2xl bg-acolhe-600 px-8 py-5 text-[1.2rem] font-extrabold text-white shadow-lg transition hover:bg-acolhe-700 sm:w-auto"
          >
